...
For a comprehensive set of rules covering test structure, naming, scope, maintainability, and security — with good and bad examples for each — see the [Consumer Best Practices guide](/consumer/best_practices).
