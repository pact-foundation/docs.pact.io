...
* support customising webhook requests	 ([d20a8274](https://github.com/pact-foundation/pact_broker/commit/d20a8274))
* Optimize WIP Query Performance to Prevent Timeouts on Large Datasets (#902)	 ([711ac3c6](https://github.com/pact-foundation/pact_broker/commit/711ac3c6))

#### Bug Fixes

* add missing import and small improvement to batch delete (#899)	 ([2e83d012](https://github.com/pact-foundation/pact_broker/commit/2e83d012))
* new unit test failure	 ([6c39e927](https://github.com/pact-foundation/pact_broker/commit/6c39e927))
* avoid N+1 cascade	 ([681d98d9](https://github.com/pact-foundation/pact_broker/commit/681d98d9))
* dont create index for mysql	 ([1ec72cc8](https://github.com/pact-foundation/pact_broker/commit/1ec72cc8))
* Pacticipant API returning undeployed versions in pacticipant deployed-environments endpoint (#889)	 ([e217d3ba](https://github.com/pact-foundation/pact_broker/commit/e217d3ba))

* **PACT-5504**
  * use batch delete to speed up deletion	 ([e908035a](https://github.com/pact-foundation/pact_broker/commit/e908035a))
...
* Update openapi_first and use it's coverage thing (#783)	 ([b3da850b](https://github.com/pact-foundation/pact_broker/commit/b3da850b))
* incorrect ProviderStates policy name. (#782)	 ([bddfd2d0](https://github.com/pact-foundation/pact_broker/commit/bddfd2d0))
...
* reduce contention when updating the contract_data_updated_at field for integrations (#671)	 ([ff72d03c](https://github.com/pact-foundation/pact_broker/commit/ff72d03c))
* support consumer version selector for all branches (#667)	 ([34334ca8](https://github.com/pact-foundation/pact_broker/commit/34334ca8))

* **clean**
  * use postgres advisory locks to ensure only one process can run a clean at a time (#672)	 ([637c25fa](https://github.com/pact-foundation/pact_broker/commit/637c25fa))

#### Bug Fixes

* use for_all_tag_heads instead of latest_by_consumer_tag when fetching wip by branch	 ([14148a34](https://github.com/pact-foundation/pact_broker/commit/14148a34))
* optimise WIP pacts by using branch/tag heads (#668)	 ([871209e1](https://github.com/pact-foundation/pact_broker/commit/871209e1))
* improve performance of WIP pacts by using branch heads instead of calculating latest pact for branch	 ([f9705583](https://github.com/pact-foundation/pact_broker/commit/f9705583))
...
* bulk delete branches (#652)	 ([14ac33c8](https://github.com/pact-foundation/pact_broker/commit/14ac33c8))
* add latest version for branch endpoint (#644)	 ([c216bec8](https://github.com/pact-foundation/pact_broker/commit/c216bec8))
* add no-cache header	 ([9a637327](https://github.com/pact-foundation/pact_broker/commit/9a637327))
* suppport `page` + `size` as pagination params (#642)	 ([c71089fe](https://github.com/pact-foundation/pact_broker/commit/c71089fe))
* do not include pb:record-deployment or pb:record-release relations for versions embedded in resources	 ([2f43590c](https://github.com/pact-foundation/pact_broker/commit/2f43590c))
* remove status from individual error in problem+error response	 ([a4b3ec58](https://github.com/pact-foundation/pact_broker/commit/a4b3ec58))
* add version_id indexes to deployed_versions and released_versions	 ([00fc7d10](https://github.com/pact-foundation/pact_broker/commit/00fc7d10))
* add endpoint to list branches for a pacticipant (#638)	 ([ff7e3a53](https://github.com/pact-foundation/pact_broker/commit/ff7e3a53))
* stop running tests for ruby 2.7	 ([034aba3b](https://github.com/pact-foundation/pact_broker/commit/034aba3b))
* update sinatra and rack-protection to ~> 3.0	 ([92ebbdd3](https://github.com/pact-foundation/pact_broker/commit/92ebbdd3))
* add branch endpoint supporting GET and DELETE (#635)	 ([1bb6088d](https://github.com/pact-foundation/pact_broker/commit/1bb6088d))
* optimise matrix by applying specified limit to pact publications before joining to verifications	 ([c61c324e](https://github.com/pact-foundation/pact_broker/commit/c61c324e))
* optimise matrix query when selectors with pacticipant names only are used	 ([b98f5d1a](https://github.com/pact-foundation/pact_broker/commit/b98f5d1a))
* include environment name in pact metadata	 ([e120c4e7](https://github.com/pact-foundation/pact_broker/commit/e120c4e7))
* improve wording of 'no version exits' messaging in can-i-deploy response	 ([9529c679](https://github.com/pact-foundation/pact_broker/commit/9529c679))
* improve performance of matrix when multiple selectors are specified (#631)	 ([58a28604](https://github.com/pact-foundation/pact_broker/commit/58a28604))
* add pagination parameter validation for paginated endpoints. (#626)	 ([abb0a1c6](https://github.com/pact-foundation/pact_broker/commit/abb0a1c6))
* add endpoint to list pacticipant versions by branch	 ([9b4e3f61](https://github.com/pact-foundation/pact_broker/commit/9b4e3f61))
* add endpoint to return latest pact for consumer, provider and consumer branch	 ([f77086ef](https://github.com/pact-foundation/pact_broker/commit/f77086ef))
* update required ruby version from 2.2 to 2.7	 ([f1b1e906](https://github.com/pact-foundation/pact_broker/commit/f1b1e906))
* add pagination and filtering for integrations endpoint	 ([68d7cf30](https://github.com/pact-foundation/pact_broker/commit/68d7cf30))
* add contract_data_updated_at to integrations table to speed up dashboard query (#617)	 ([e43c10f2](https://github.com/pact-foundation/pact_broker/commit/e43c10f2))
* support setting feature toggles via individual environment variables (#609)	 ([be7d9d52](https://github.com/pact-foundation/pact_broker/commit/be7d9d52))

* **metrics**
  * hardcode matrix count to -1 as calculating it causes performance issues and it has no meaning	 ([62e121b8](https://github.com/pact-foundation/pact_broker/commit/62e121b8))

* **matrix**
  * optimise identification of the 'latest tag'	 ([824c516a](https://github.com/pact-foundation/pact_broker/commit/824c516a))

#### Bug Fixes

* **metrics**
  * correct the query for pactRevisionsPerConsumerVersion	 ([f76b9935](https://github.com/pact-foundation/pact_broker/commit/f76b9935))

* fix performance issues due to contention in the integrations table when publishing a large number of contracts (> 20) per request, in parallel (#654)	 ([321a2291](https://github.com/pact-foundation/pact_broker/commit/321a2291))
* raise 404 on paths with missing path segments (#648)	 ([930b45cd](https://github.com/pact-foundation/pact_broker/commit/930b45cd))
* do not error when no environment is found by name	 ([d1501618](https://github.com/pact-foundation/pact_broker/commit/d1501618))
* ensure pact associations are eager loaded when finding a single pact	 ([c98abda6](https://github.com/pact-foundation/pact_broker/commit/c98abda6))
* gracefully handle validating an array when a hash is expected	 ([b26ddb46](https://github.com/pact-foundation/pact_broker/commit/b26ddb46))
* fix error occuring when can-i-deploy badge is requested and no version is found	 ([db7dee3a](https://github.com/pact-foundation/pact_broker/commit/db7dee3a))
* fix bug in error handling for 'can-i-deploy branch to environment' badge	 ([c23beb6b](https://github.com/pact-foundation/pact_broker/commit/c23beb6b))
* improve performance of network diagram (#614)	 ([ffd3ec4b](https://github.com/pact-foundation/pact_broker/commit/ffd3ec4b))
* fix error raised when attempting to log warning when webhook_redact_sensitive_data is set to false	 ([9b66270e](https://github.com/pact-foundation/pact_broker/commit/9b66270e))
* gracefully handle execution of webhooks that are deleted between execution attempts (#613)	 ([1127b41f](https://github.com/pact-foundation/pact_broker/commit/1127b41f))
* add extra validation to ensure parsed content is a hash when publishing pacts	 ([913e0a52](https://github.com/pact-foundation/pact_broker/commit/913e0a52))

* **matrix**
  * return only most recent row missing verification when latestby=cp	 ([b7550e53](https://github.com/pact-foundation/pact_broker/commit/b7550e53))
...
* add missing require in migration	 ([6b540235](https://github.com/pact-foundation/pact_broker/commit/6b540235))
...
* add index to webhook_executions pact_publication_id column	 ([37d1a4cf](https://github.com/pact-foundation/pact_broker/commit/37d1a4cf))
* update webmachine to support ruby 3	 ([9bb014e6](https://github.com/pact-foundation/pact_broker/commit/9bb014e6))
* upgrade dry-validation gem in preparation for ruby 3 upgrade	 ([3b4b66bf](https://github.com/pact-foundation/pact_broker/commit/3b4b66bf))
* restructure logs from DeleteOverwrittenData to match CleanIncremental	 ([f11a9417](https://github.com/pact-foundation/pact_broker/commit/f11a9417))
* add branch_heads_branch_version_id_index	 ([b1b4cefb](https://github.com/pact-foundation/pact_broker/commit/b1b4cefb))

#### Bug Fixes

* **pacts for verification**
  * do not allow empty string for provider version branch when it is required for calculating WIP/pending pacts	 ([412c4289](https://github.com/pact-foundation/pact_broker/commit/412c4289))

* fix error raised when clean selectors include a selector with a max age and a selector with a max age and a branch	 ([53b171bd](https://github.com/pact-foundation/pact_broker/commit/53b171bd))

* **can-i-deploy**
  * correct logic for detecting when only the pacticipant name has been specified for a selector	 ([85bcdb35](https://github.com/pact-foundation/pact_broker/commit/85bcdb35))
