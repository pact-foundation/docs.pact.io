...
See: [docs/alpine-ffi-troubleshooting.md](/implementation_guides/php/docs/alpine-ffi-troubleshooting)
...
| ------- | ---------- | -------------------- | ----------------- | ------------------ |
| 11.x    | Developing | 1, 1.1, 2, 3, 4      | ^8.2              | See [installation] |
| 10.x    | Stable     | 1, 1.1, 2, 3, 4      | ^8.1              | See [installation] |
| 9.x     | Deprecated | 1, 1.1, 2, 3\*       | ^8.0              | [9xx]              |
