...
* The ability to log to file (via `log`) is not currently supported.
* Multiple requests per test are not currently supported (see https://github.com/pact-foundation/pact-js/issues/1078)
