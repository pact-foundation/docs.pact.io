...
![Pact tests architecture](/img/pact-v2-arch.png)
...
More at [http_client_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/http_client_spec.rb)
...
More at [grpc_client_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/grpc_client_spec.rb)
...
More at [message_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/message.spec.rb)
...
More at [kafka_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/kafka_spec.rb)
...
For details of the implementation, see [matchers.rb](https://github.com/pact-foundation/pact-ruby/tree/master/lib/pact/v2/matchers.rb)
...
See the different uses of the matchers in [matchers_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/v2/matchers_spec.rb)
...
For details of the implementation, see [matchers.rb](https://github.com/pact-foundation/pact-ruby/tree/master/lib/pact/v2/generators.rb)
...
- animal service
  - v1 [example/animal-service](https://github.com/pact-foundation/pact-ruby/tree/master/example/animal-service/)
  - v2 [example/animal-service-v2](https://github.com/pact-foundation/pact-ruby/tree/master/example/animal-service-v2/)
- zoo app
  - v1 [example/zoo-app](https://github.com/pact-foundation/pact-ruby/tree/master/example/zoo-app/)
  - v2 [example/zoo-app-v2](https://github.com/pact-foundation/pact-ruby/tree/master/example/zoo-app-v2/)
...
- http consumer [http_client_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/http_client_spec.rb)
- kafka consumer with pact-ruby wrapper [kafka_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/kafka_spec.rb)
- message consumer [message_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/message_spec.rb)
- plugin consumer http [plugin_matt_http_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/plugin_matt_http_spec.rb)
- plugin consumer http [plugin_matt_sync_message_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/plugin_matt_sync_message_spec.rb)
- plugin consumer http [plugin_matt_async_message_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/plugin_matt_async_message_spec.rb)
- plugin consumer http [plugin_matt_http_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/plugin_matt_http_spec.rb)
- grpc consumer with pact-ruby wrapper [grpc_client_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/grpc_client_spec.rb)
- grpc consumer using direct plugin interface [plugin_grpc_sync_message_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/providers/pact-ruby-v2-test-app/plugin_grpc_sync_message_spec.rb)
- mixed(http/kafka/grpc) provider [multi_spec.rb](https://github.com/pact-foundation/pact-ruby/tree/master/spec/pact/consumers/multi_spec.rb)