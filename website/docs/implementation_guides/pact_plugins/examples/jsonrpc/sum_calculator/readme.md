---
title: JSON-RPC sum calculator example
sidebar_label: JSON-RPC sum calculator example
custom_edit_url: https://github.com/pact-foundation/pact-plugins/edit/main/examples/jsonrpc/sum_calculator/README.md
---
