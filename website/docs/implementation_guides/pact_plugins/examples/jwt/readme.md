---
title: JWT Examples
sidebar_label: JWT Examples
custom_edit_url: https://github.com/pact-foundation/pact-plugins/edit/main/examples/jwt/README.md
---
...
These examples demonstrate using the [JWT plugin](https://github.com/pact-foundation/pact-plugins/blob/main/plugins/jwt) (written in Lua) to support requests and
...
build step, just run [`install-local.sh`](https://github.com/pact-foundation/pact-plugins/blob/main/plugins/jwt/install-local.sh) in the [plugins/jwt](https://github.com/pact-foundation/pact-plugins/blob/main/plugins/jwt)
directory. See [the plugin docs](https://github.com/pact-foundation/pact-plugins/blob/main/plugins/jwt/README.md) for details.
