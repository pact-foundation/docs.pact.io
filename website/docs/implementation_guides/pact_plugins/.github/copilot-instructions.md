---
title: Copilot instructions for `pact-plugins`
sidebar_label: Copilot instructions for `pact-plugins`
custom_edit_url: https://github.com/pact-foundation/pact-plugins/edit/main/.github/copilot-instructions.md
---
