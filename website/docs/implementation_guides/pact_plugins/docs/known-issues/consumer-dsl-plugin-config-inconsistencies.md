---
title: Consumer DSL / plugin config inconsistencies between pact-jvm and pact-reference
sidebar_label: Consumer DSL / plugin config inconsistencies between pact-jvm and pact-reference
custom_edit_url: https://github.com/pact-foundation/pact-plugins/edit/main/docs/known-issues/consumer-dsl-plugin-config-inconsistencies.md
---
...
[`002_Support_script_language_plugins.md`](/implementation_guides/pact_plugins/docs/proposals/proposal_002_support_script_language_plugins))
