---
title: Lua plugin function reference
sidebar_label: Lua plugin function reference
custom_edit_url: https://github.com/pact-foundation/pact-plugins/edit/main/docs/lua-plugin-reference.md
---
...
[Writing plugins in Lua](https://github.com/pact-foundation/pact-plugins/blob/main/writing-plugin-guide.md#writing-plugins-in-lua) in the plugin writing guide. This document
...
[pure-Lua LuaRocks package](https://github.com/pact-foundation/pact-plugins/blob/main/writing-plugin-guide.md#luarocks-support) that provides them - packages with compiled C
extensions are not supported.

Lua's built-in `print(...)` is also redirected into the same per-instance log file as `logger(...)`, rather than
the driver's own real stdout - see [Output and logging](https://github.com/pact-foundation/pact-plugins/blob/main/writing-plugin-guide.md#output-and-logging).
