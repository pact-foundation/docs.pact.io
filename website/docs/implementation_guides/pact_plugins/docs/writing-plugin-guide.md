...
sidebar_label: Guide to writing a Pact plugin
...
The CSV plugin is written in Rust and the Protobuf one in Kotlin. There is also a [JWT](https://github.com/pact-foundation/pact-plugins/blob/main/plugins/jwt) plugin written
...
Version 2 of the plugin interface ([plugin_v2.proto](https://github.com/pact-foundation/pact-plugins/blob/main/proto/plugin_v2.proto)) extends v1 with capability
...
See the [CSV plugin](https://github.com/pact-foundation/pact-plugins/blob/main/plugins/csv/src/main.rs) for a complete Rust reference implementation.
...
See the [JWT plugin](https://github.com/pact-foundation/pact-plugins/blob/main/plugins/jwt) for a complete, working reference implementation, and
[its examples](https://github.com/pact-foundation/pact-plugins/blob/main/examples/jwt) for consumer/provider tests exercising it on both drivers.
...
[Content Matchers and Generators](https://github.com/pact-foundation/pact-plugins/blob/main/content-matcher-design.md)); a Lua plugin gets full provider-verification support
