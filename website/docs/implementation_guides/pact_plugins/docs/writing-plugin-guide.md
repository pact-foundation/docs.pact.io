...
message payloads and are based on specified MIME types. Refer to [Content Matchers and Generators](https://github.com/pact-foundation/pact-plugins/blob/main/content-matcher-design.md) 
