---
title: Driver-plugin callback model (Draft)
sidebar_label: Driver-plugin callback model (Draft)
custom_edit_url: https://github.com/pact-foundation/pact-plugins/edit/main/docs/proposals/007_Driver_plugin_callback_model.md
---
