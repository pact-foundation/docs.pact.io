...
- [007 Driver-plugin callback model](/implementation_guides/pact_plugins/docs/proposals/proposal_007_driver_plugin_callback_model), which defines *how* a plugin calls back
...
- [006 Field-level matchers and generators](/implementation_guides/pact_plugins/docs/proposals/proposal_006_field_level_matchers_and_generators), which defines *what shape*
...
- Build on [006](/implementation_guides/pact_plugins/docs/proposals/proposal_006_field_level_matchers_and_generators)'s field-level operation shape so plugins can delegate at
...
- The interface is transport-agnostic by construction, since it's the same 007 mechanism used for:
  ...
  - in-process WASM plugins (see [003](/implementation_guides/pact_plugins/docs/proposals/proposal_003_support_wasm_plugins), via host-exported functions);
  - in-process Lua plugins (via host functions registered into the Lua VM).

## Non-goals for this proposal

- Defining the generic callback protocol on its own (see [007](/implementation_guides/pact_plugins/docs/proposals/proposal_007_driver_plugin_callback_model)).
- Defining new field-level matcher/generator operations from scratch (see [006](/implementation_guides/pact_plugins/docs/proposals/proposal_006_field_level_matchers_and_generators)).
...
This maps directly onto [007](/implementation_guides/pact_plugins/docs/proposals/proposal_007_driver_plugin_callback_model)'s WASM transport section: the standard matcher/
...
- [007 Driver-plugin callback model](/implementation_guides/pact_plugins/docs/proposals/proposal_007_driver_plugin_callback_model) defines how the host exposes capabilities
...
- [005 Plugin capability negotiation and versioning](/implementation_guides/pact_plugins/docs/proposals/proposal_005_plugin_capability_negotiation_and_versioning) is how a
