...
**NOTE:** If you are using Java 8, there is no separate Java 8 support library anymore, there is [an updated DSL for consumer tests](/implementation_guides/jvm/consumer/) requiring a minimum of Java 11.
...
If you use Gradle, you can use the [pact Gradle plugin](/implementation_guides/jvm/provider/gradle#publishing-pact-files-to-a-pact-broker) to publish your pact files.
