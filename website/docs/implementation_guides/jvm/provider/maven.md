...
**This plugin is used to verify a running provider. If you want to verify your provider using unit tests, refer to the [JUnit 4](/implementation_guides/jvm/provider/junit) or [JUnit 5](/implementation_guides/jvm/provider/junit5) docs.**
