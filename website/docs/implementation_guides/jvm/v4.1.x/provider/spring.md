...
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.1.x/provider/spring/README.md
---
...
This library is based on and references the JUnit package, so see the [Pact JUnit 4](/implementation_guides/jvm/v4.1.x/provider/junit) or [Pact JUnit 5](/implementation_guides/jvm/v4.1.x/provider/junit5) providers for more details regarding configuration using JUnit.
