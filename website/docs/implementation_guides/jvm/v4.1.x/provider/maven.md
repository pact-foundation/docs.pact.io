...
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.1.x/provider/maven/README.md
---
...
**This plugin is for verifying a running provider. For verifying your provider using unit tests, refer to the [JUnit 4](/implementation_guides/jvm/v4.1.x/provider/junit) or [JUnit 5](/implementation_guides/jvm/v4.1.x/provider/junit5) docs.**
