...
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.1.x/provider/junit/README.md
---
...
**NOTE: `@TargetRequestFilter` is only for JUnit 4. For JUnit 5 see [JUnit 5 docs](/implementation_guides/jvm/v4.1.x/provider/junit5#modifying-the-requests-before-they-are-sent).**
