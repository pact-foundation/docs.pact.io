...
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.1.x/consumer/java8/README.md
---
...
This is an extension for the pact DSL provided by [consumer](https://github.com/pact-foundation/pact-jvm/blob/v4.1.x/consumer/consumer). The difference between
