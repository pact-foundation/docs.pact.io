...
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.5.x/consumer/junit/README.md
---
...
**NOTE:** If you are using Java 8, there is no separate Java 8 support library anymore, there is [an updated DSL for consumer tests](/implementation_guides/jvm/v4.5.x/consumer/) requiring a minimum of Java 11.
