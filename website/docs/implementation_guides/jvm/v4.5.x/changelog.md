---
title: Changelog
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.5.x/CHANGELOG.md
---
...
* 14982ec3d - Squashed 'compatibility-suite/pact-compatibility-suite/' changes from d22d4667c..416f3a64d (Ronald Holshausen, Mon Feb 19 13:15:39 2024 +1100)
* 0c10b6e1c - fix: Add tests for generating URLs with null or empty query parameter values #1788 (Ronald Holshausen, Thu Apr 18 11:20:45 2024 +1000)
* a311746c9 - fix: IndexOutOfBoundsException when query param without value #1788 (Ronald Holshausen, Wed Apr 17 17:28:56 2024 +1000)
* 815f88711 - feat(consumer/groovy): Support matchers on plain text bodies #443 (Ronald Holshausen, Tue Mar 26 16:44:35 2024 +1100)
* bd1d739ef - feat(consumer-dsl): Support object and array expectation without specifying consumer in LambdaDSL #1737 (Ronald Holshausen, Tue Mar 26 15:52:18 2024 +1100)
* fa6714cb2 - feat(consumer-dsl): Support request body as byte array #1777 (Ronald Holshausen, Tue Mar 26 15:03:32 2024 +1100)
* 151211e76 - fix: allow synchronous messages to be saved in a v4 pact json report (Gert Jan Kersten, Wed Mar 20 08:14:38 2024 +0100)
* 3670bbd43 - feat: Add interaction description to the verification payload sent to the Pact Broker (Ronald Holshausen, Tue Feb 20 13:57:56 2024 +1100)
* 043f58ec2 - fix: Matching rules for query strings with square brackets were not bing written in V2 format correctly #1766 (Ronald Holshausen, Fri Feb 16 14:17:12 2024 +1100)
* a81db8b76 - fix: Provider branch not sent to Pact Broker in consumer version selectors if enablePending=false #1769 (Ronald Holshausen, Fri Feb 16 10:25:53 2024 +1100)
* b9e96df03 - fix: matchPath should validate that the example provided explicitly matches the regex #1767 (Ronald Holshausen, Thu Feb 15 12:05:33 2024 +1100)
* ac328e2e2 - fix: when Preemptive Authentication is enabled, basic auth creds were not being set correctly #1764 (Ronald Holshausen, Tue Jan 30 15:07:58 2024 +1100)
* a1d589c9b - fix: Implemented missing atLeast and atMost options with matching rule definitions (Ronald Holshausen, Tue Jan 30 13:42:01 2024 +1100)
* 7fabb53c2 - fix: newJsonBody() builder unable to handle certain field names #1760 (Ronald Holshausen, Thu Jan 18 11:46:48 2024 +1100)
* 5924d90cb - fix: Add set-cookie header to the list of single value headers (Ronald Holshausen, Wed Jan 17 13:52:06 2024 +1100)
* 8e0f0c36a - fix: Support V2 format with header/query params with encoded paths (Ronald Holshausen, Wed Jan 17 11:49:09 2024 +1100)
* 3fc647a52 - Issue 1758 - Add latest flag when comparing to the main branch so only the latest contract is checked (jordan.eales, Tue Jan 9 14:41:34 2024 +0000)
* 69d51638a - feat: Add tests for supportingmultiple test targets with JUnit 5 #1708 (Ronald Holshausen, Sat Dec 16 19:05:46 2023 +1100)
* 2a4df7c9e - feat: Support multiple test targets with JUnit 5 #1708 (Ronald Holshausen, Fri Dec 15 23:36:28 2023 +1100)
* 1df2b1fff - fix: Message metadata is parsed as JSON, so need to check for JSON types #1749 (Ronald Holshausen, Fri Dec 15 12:21:32 2023 +1100)
* d6390a8c0 - Issue 1741 - Add to main branch option to match what is possible in the Pact Flow UI (jordan.eales, Thu Dec 7 16:28:46 2023 +0000)
* 986a4ea43 - Fix another typo (biergit, Wed Nov 29 09:59:50 2023 +0100)
* 8a3064002 - Fix typos (biergit, Wed Nov 29 09:58:11 2023 +0100)
* 891605d35 - fix: Message matching rules can be defined under content instead of body #1509 (Ronald Holshausen, Wed Nov 15 15:36:20 2023 +1100)
* e7d501dd1 - Chore: Add test with headers with params with no values #1727 (Ronald Holshausen, Wed Nov 15 10:02:43 2023 +1100)
* 666a47bce - fix: Unstable key generation with provider states #1717 (Ronald Holshausen, Thu Sep 21 12:36:54 2023 +1000)
* e16aea834 - fix: If the JUnit test framework has an exception, add a failure to the test results #1715 (Ronald Holshausen, Thu Sep 21 11:58:10 2023 +1000)
* 02a0d5699 - feat: Update the new builder DSL to allow setting contents as byte arrays #600 (Ronald Holshausen, Thu Sep 21 10:56:54 2023 +1000)
* 2d86f4451 - feat: Retry all http methods (Sebastian Lohmeier, Mon Sep 4 22:03:05 2023 +0200)
* 662da3ccf - feat: Add support for adding multiparts that can use JSON DSL #1642 (Ronald Holshausen, Tue Aug 22 11:50:21 2023 +1000)
...
See [Modifying The Requests Before They Are Sent](/implementation_guides/jvm/v4.5.x/provider/gradle#modifying-the-requests-before-they-are-sent)
