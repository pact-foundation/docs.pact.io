---
title: README
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.5.x/README.md
slug: ./readme
---
...
You want to look at: [junit](/implementation_guides/jvm/v4.5.x/consumer/junit) for JUnit 4 tests and
[junit5](/implementation_guides/jvm/v4.5.x/consumer/junit5) for JUnit 5 tests. Also, if you are using Java 11 or above, there is [an
updated DSL for consumer tests](/implementation_guides/jvm/v4.5.x/consumer).
...
You want to look at: [groovy](/implementation_guides/jvm/v4.5.x/consumer/groovy) or [junit](/implementation_guides/jvm/v4.5.x/consumer/junit)

### (Use Clojure I)

Clojure can call out to Java, so have a look at [junit](/implementation_guides/jvm/v4.5.x/consumer/junit). For an example
...
You want to look at: [Consumer](/implementation_guides/jvm/v4.5.x/consumer)
...
You want to look at: [pact gradle plugin](/implementation_guides/jvm/v4.5.x/provider/gradle)

#### verify pacts with Maven

You want to look at: [pact maven plugin](/implementation_guides/jvm/v4.5.x/provider/maven)

#### verify pacts with JUnit tests

You want to look at: [junit provider support](/implementation_guides/jvm/v4.5.x/provider/junit) for JUnit 4 tests and 
 [junit5](/implementation_guides/jvm/v4.5.x/provider/junit5) for JUnit 5 tests

#### verify pacts with Leiningen

You want to look at: [pact leiningen plugin](/implementation_guides/jvm/v4.5.x/provider/lein)

#### verify pacts with a Spring MVC project

Have a look at [spring](/implementation_guides/jvm/v4.5.x/provider/spring) or [Spring MVC Pact Test Runner](https://github.com/realestate-com-au/pact-jvm-provider-spring-mvc) (Not maintained).

#### I want to verify pacts but don't want to use sbt or gradle or leiningen

You want to look at: [provider](/implementation_guides/jvm/v4.5.x/provider)
...
pact plugin supports a mechanism where you can verify V3 message pacts, have a look at [pact gradle plugin](/implementation_guides/jvm/v4.5.x/provider/gradle#verifying-a-message-provider).
The JUnit pact library also supports verification of V3 message pacts, have a look at [junit](/implementation_guides/jvm/v4.5.x/provider/junit#verifying-a-message-provider).
...
There's a limit to how much we can help, however check out [pact-jvm-server](/implementation_guides/jvm/v4.5.x/pact-jvm-server)
