...
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.5.x/provider/maven/README.md
---
...
**This plugin is used to verify a running provider. If you want to verify your provider using unit tests, refer to the [JUnit 4](/implementation_guides/jvm/v4.5.x/provider/junit) or [JUnit 5](/implementation_guides/jvm/v4.5.x/provider/junit5) docs.**
