...
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.5.x/provider/junit5/README.md
---
...
For details on the provider and pact source annotations, refer to the [Pact junit runner](/implementation_guides/jvm/v4.5.x/provider/junit) docs.
...
Provider State Methods work in the same way as with JUnit 4 tests, refer to the [Pact junit runner](/implementation_guides/jvm/v4.5.x/provider/junit) docs.
...
WIP pacts work in the same way as with JUnit 4 tests, refer to the [Pact junit runner](/implementation_guides/jvm/v4.5.x/provider/junit) docs.
