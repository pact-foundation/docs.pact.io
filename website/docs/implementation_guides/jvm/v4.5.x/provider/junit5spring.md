...
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/v4.5.x/provider/junit5spring/README.md
---
...
This module extends the base [Pact JUnit5 module](/implementation_guides/jvm/v4.5.x/provider/junit5). See that for more details.
