---
title: README
custom_edit_url: https://github.com/pact-foundation/pact-jvm/edit/master/README.md
slug: ./readme
---
...
|-----------------------------------------------------------------------------------|---------------|-----------------------|----------------|----------------|-------|
| [4.7.x](https://github.com/pact-foundation/pact-jvm/blob/v4.7.x/README.md)        | V4 + plugins  | 17+ (tested up to 23) | 2.1.21         | 4.7.0-beta.1   |       |
