...
Pact-net: Next major release is not far away, with the Pact specification v3 beta stabilising: [v4.0.0-beta.3](https://github.com/pact-foundation/pact-net/).

Chat with us in: [#pact-net](https://pact-foundation.slack.com/archives/C9UTHV2AD)

### Golang

Pact-go: Next major release is not far away, with the Pact specification v3 beta stabilising: [v2.0.0-beta.10](https://github.com/pact-foundation/pact-go/tree/2.x.x).

Chat with us in: [#pact-go](https://pact-foundation.slack.com/archives/C9UTHTFFB)

### Node JS

Pact-JS: Pact specification V3 beta now available: [v10.0.0-beta.59](https://github.com/pact-foundation/pact-js/tree/feat/v3.0.0/). Follow the [roadmap progress.](https://github.com/pact-foundation/pact-js/projects/3)
...
Pact-Python: Message support was added in 2021 to enable testing of asynchronous integrations such as RabbitMQ or Kafka ([pact-python#194](https://github.com/pact-foundation/pact-python/pull/194), [pact-python#251](https://github.com/pact-foundation/pact-python/pull/251)).
...
- 📙 Read the V4 spec RFC for a full list of changes: [pact-specification#71](https://github.com/pact-foundation/pact-specification/issues/71)
