...
- Pact-JS
  ...
  - ARM64 Support
        <https://github.com/pact-foundation/pact-js-core/pull/404>

  - V4 Error handling logic
        <https://github.com/pact-foundation/pact-js/pull/942>

  - fix: Fix issue where MatchersV3.string() with no arguments would
        not correctly match strings
        <https://github.com/pact-foundation/pact-js/pull/946>

- Pact-PHP

  - fix: provider-verifier bad arguments naming
        <https://github.com/pact-foundation/pact-php/pull/272>

  - Support matchers in path
        <https://github.com/pact-foundation/pact-php/pull/264>

  - Unlock amphp/cache
        <https://github.com/pact-foundation/pact-php/pull/275>

- Pact-JVM

  - Fix issue with consumer version selector method being protected
        <https://github.com/pact-foundation/pact-jvm/pull/1605>

  - Use Thread Context ClassLoader to find test resources
        <https://github.com/pact-foundation/pact-jvm/pull/1607>

  - Bump version of Kotlin Result to work around build failures
        <https://github.com/pact-foundation/pact-jvm/pull/1606>

- Pact-Reference

  - fix(verifier): fix typos in the implementation of Display on the
        PactSource enum
        <https://github.com/pact-foundation/pact-reference/pull/218>

  - fix(pact_verifier_cli): stop using deprecated
        clap::parser::matches::arg_matches::ArgMatches::values_of_lossy
        <https://github.com/pact-foundation/pact-reference/pull/219>
...
- Pact PHP -- [Upgrade to Rust
    FFI](https://github.com/pact-foundation/pact-php/pull/270)

- Pact Support/Pact Ruby -- Support for V3 Generators / Provider
    States

  - <https://github.com/pact-foundation/pact-ruby/pull/273>

  - <https://github.com/pact-foundation/pact-support/pull/97>

- NestJS-Pact -- [Upgrade to NestJS
    V10](https://github.com/pact-foundation/nestjs-pact/pull/17)

- Pact Python -- Message pact matchers

- Pact JVM -

  - [Make the Gradle Plugin compatible with Gradle Configuration
        Cache](https://github.com/pact-foundation/pact-jvm/pull/1627)

  - [[Kotlin extension to build Json dsl]{.ul} based on required
        constructor
        fields](https://github.com/pact-foundation/pact-jvm/pull/1628/files)

- [Pact-Net -- Support for Provider States]{.ul}

## Updates to documentation and learning materials

The following documentation is now live, or updated on the site:

- Pact-Specification -- All about the spec. Learn the history,
    philosophy, implementation support, migration notes, and more.

  - <https://docs.pact.io/implementation_guides/pact_specification>

- Pact-Plugins -- The Pact plugins docs are now syncing from their
    readme, and displayed alongside our other Pact tooling. (Join us for
    the official launch next month.)

  - <https://docs.pact.io/implementation_guides/pact_plugins>

- Webhook template library -- Updated to use the new contract
    requiring verification published event. We\'d love your help to add
    new ones to the list!

  - <https://docs.pact.io/pact_broker/webhooks/template_library>

- Branch support in Client libraries -- The list has been updated to
    show the latest state of play.

  - https://docs.pact.io/pact_broker/branches\#support

- Community Repos -- We've got a new showcase for Pact based repos in
    the wild. List yours here.

  - <https://docs.pact.io/community_repos>

- New articles -- Check them out.

  - <https://docs.pact.io/blogs_videos_and_articles>

- New workflow recommendations -- A large scale migration of the docs,
    > to use our new recommended configuration (publishing/verifying
    > with the branch property set, using the new contract requiring
    > verification published event, enabling pending/wip pacts).

  - See it in action in the updated CI/CD workshop
        <https://docs.pactflow.io/docs/workshops/ci-cd/>

  - Full PR of docs.pact.io site wide changes
        <https://github.com/pact-foundation/docs.pact.io/pull/174/files>
...
Paulo Gonçalves did just that in this
...
PLUS extra kudos to Paulo, who delivered a [contract testing workshop
entirely in Spanish](https://www.youtube.com/watch?v=1c2JmM9dafA) for
...
A talented Developer Advocate, **Liran Tal** at Synk is a long-time
...
because, as you already know, contract testing is AWESOME! :ok:\
\
...
As the Pact Community Sheppard, I\'m dedicated to making it as easy as
