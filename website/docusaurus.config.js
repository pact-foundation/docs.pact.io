...
const siteConfig = {
  ...
  themeConfig: {
    announcementBar: {
      id: 'announcement-bar',
      content: '<div id="announcement-bar">🎂 Happy Official 10th Birthday, Pact! Join us for our <a target="_blank" href="pact.io/pactober.html">Pactober celebration</a>.</div>',
